...
> [!NOTE]
> 当前版本是 Aegis v2.0.0，上一版本是 Aegis v1.2.4，此次为 MAJOR 更新（MAJOR=2），必须重新下载配置，并重新添加节点，会自动更新外部资源。
>
> 当前版本是 Aegis v3.3.0，上一版本是 Aegis v3.2.2，此次为 MINOR 更新（MINOR=3），建议重新下载配置，并重新添加节点，会自动更新外部资源。
>
