...
Personal digital firewall ruleset for Surge on iOS & macOS, built for precise local traffic identification, classification, and user-defined traffic policies. Available in Simplified Chinese, Traditional Chinese, and English for global deployment and flexible use.
