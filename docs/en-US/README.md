...
Personal digital firewall ruleset for Surge on iOS & macOS, built for precise local traffic identification, classification, and user-defined traffic policies. 
...
- See [Aegis Wiki Video Tutorials](https://github.com/Thoseyearsbrian/Aegis/wiki/Video-Tutorials)
